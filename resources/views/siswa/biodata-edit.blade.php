                ...
                <div style="display:flex; gap:20px; align-items:flex-start;">
                    <div style="flex:1;">
                        <div id="foto-preview" style="margin-bottom:15px;">
                            ...
                            @else
                                <div style="width:120px; height:160px; background:#f3f4f6; border:2px dashed #d1d5db; border-radius:8px; display:flex; align-items:center; justify-content:center;">

                    ...
                    @if(Auth::user()->hasRole('admin'))
                        ...
                        <div class="hidden sm:flex sm:items-center" x-data="{ openLaporan: false }">
                            <div class="relative">
                                ...
                                <div x-show="openLaporan" @click.away="openLaporan = false" x-transition class="absolute z-50 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5">
                                    <div class="py-1">
                                        <a href="{{ route('admin.laporan.pendaftar') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 {{ request()->routeIs('admin.laporan.pendaftar') ? 'bg-gray-100 dark:bg-gray-600 font-semibold' : '' }}">Laporan Pendaftar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="pt-2 pb-3 space-y-1">
            @if(Auth::user()->hasRole('admin'))
                ...
                <div class="pt-2 pb-1 px-4">
                    <p class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Laporan</p>
                </div>
                <x-responsive-nav-link :href="route('admin.laporan.pendaftar')" :active="request()->routeIs('admin.laporan.pendaftar')">
                    {{ __('Laporan Pendaftar') }}
                </x-responsive-nav-link>
            @else

    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="https://pmbm.man4kotapekanbaru.my.id/siswa/kartu-ujian" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 hover:shadow-md transition block">
                    <div class="flex items-center">
                ...
                <a href="{{ route('siswa.biodata.edit') }}" class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 hover:shadow-md transition block">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 rounded-md p-3" style="background-color:#16a34a;">
                            <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                        </div>
                        <div class="ml-4">
                            <p class="font-semibold text-gray-900 dark:text-gray-100">Edit Biodata</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Lengkapi & perbarui data diri</p>
                        </div>
                    </div>
                </a>
